...
import 'Item.dart';
import 'item_detail_screen.dart'; // Importamos la pantalla de detalles
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.pink.shade50, // Cambia el color del encabezado
      ),
          ...
          return Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                primary: Colors.blue.shade50, // Cambia el color del botón
                textStyle: const TextStyle(fontSize: 18),
                padding: const EdgeInsets.all(20), // Aumenta el espacio interno del botón
              ),
            ),
          );
        },
